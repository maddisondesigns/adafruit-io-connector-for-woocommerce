...
The order information is prefixed by your specified text. By default, this is "New Order:". If the customer order contains only one product, then the product name will be appended to your prefix text.
...
Where:
[first product name] is replaced with the name of the first product in the order
...
For use with WooCommerce 4.0 and above. This plugin is HPOS compatible.
